...
import com.example.android.pyramid.HuntMainActivity.Companion.ACTION_GEOFENCE_EVENT
...
class GeofenceBroadcastReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        if (intent.action == ACTION_GEOFENCE_EVENT) {
            ...
            val entered = geofencingEvent.geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER
