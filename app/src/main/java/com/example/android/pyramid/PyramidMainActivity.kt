...
import com.example.android.pyramid.databinding.ActivityPyramidMainBinding
...
class HuntMainActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityPyramidMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_pyramid_main)
    ...
    override fun onNewIntent(intent: Intent?) {
        ...
        if(extras != null){
            if(extras.containsKey(GeofencingConstants.EXTRA_GEOFENCE_ENTERED_OR_EXITED)){
                val enteredOrExited = extras.getBoolean(GeofencingConstants.EXTRA_GEOFENCE_ENTERED_OR_EXITED)
                viewModel.updateEnteredOrExited(enteredOrExited)
                checkPermissionsAndStartGeofencing()
            }
        }
    }
