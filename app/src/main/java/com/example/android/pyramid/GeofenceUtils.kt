...
internal object GeofencingConstants {
    ...
    val LANDMARK_DATA = arrayOf(
        ...
        LandmarkDataObject(
            "rue_des_pyramides",
            R.string.rue_des_pyramides_hint,
            R.string.rue_des_pyramides_location,
            LatLng(48.866241, 2.33379))
    )

    const val GEOFENCE_RADIUS_IN_METERS = 20f
    const val EXTRA_GEOFENCE_ENTERED_OR_EXITED = "GEOFENCE_ENTERED_OR_EXITED"
}
